...
software-qualification-check:
	PYTHONPATH=$(PYTHONPATH) python -m pytest tests/test_sensor_impairments.py tests/test_software_qualification.py

ml-release-check:
	PYTHONPATH=$(PYTHONPATH) python -m pytest tests/test_ml_release.py
